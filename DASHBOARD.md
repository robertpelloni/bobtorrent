...
| Supernode | `build/supernode-go` | Buildable | Tracker, DHT, seeding, market automation, TUI, Bobcoin UI-compatible status/economy/proof/FHE-oracle/control endpoints, WASM artifact serving, manifest/shard publication registry, and durable local transaction logging |
