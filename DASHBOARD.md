...
|---|---|---:|---|
| Bobcoin | `bobcoin/` | Active | Frontend + game stack remains the primary UI reference; now includes Go storage WASM workbench, publication flow, browser-side retrieval/reconstruction, signed Go-lattice manifest anchoring, a searchable Vault archive browser, and archive reuse inside Market/Gallery flows (`v8.14.0`). |
