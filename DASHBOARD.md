...
## Current Known Gaps
- Lattice peer sync now has bootstrap/catch-up, health/retry telemetry, cooldown suppression, and divergence suspicion, but richer reconciliation and heavier policy tuning still remain open
